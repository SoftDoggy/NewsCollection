                ...
                <div class="banner-grids">
                    <div class="banner-top">
                        ...
                        <ul class="nav banner-nav">
                            <li class="active"><a href="loginHome.jsp">首页</a></li>
                            ...
                            <div class="col-md-8 banner-bottom-left">
                                <div class="banner-bottom-left-grids">
                                    <div class="col-md-6 banner-left-grid">
                                        <ul>
                                            <li><h3><%=session.getAttribute("Interest1")%></h3></li>
                                            <li class="mor">
                                    ...
                                    <div class="col-md-6 banner-left-grid">
                                        <ul>
                                            <li><h3><%=session.getAttribute("Interest2")%></h3></li>
                                            <li class="mor">
                                                <a class="view" href="#">view more...</a>
                                            </li>
                                        </ul>
                                ...
                                <div class="banner-bottom-left-grids">
                                    <div class="col-md-6 banner-left-grid">
                                        <ul>
                                            <li><h3><%=session.getAttribute("Interest3")%></h3></li>
                                            <li class="mor">
                                                <a class="view" href="#">view more...</a>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="col-md-6 banner-left-grid">
                                        <ul>
                                            <li><h3><%=session.getAttribute("Interest4")%></h3></li>
                                            <li class="mor">
                                                <a class="view" href="#">view more...</a>
                                            </li>
                                        </ul>
